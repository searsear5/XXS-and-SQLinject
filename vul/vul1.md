(CVSS & VPR)
หัวข้อ | CVSS |	VPR
คืออะไร | คะแนนความรุนแรงของช่องโหว่ (มาตรฐาน) | ความเสี่ยงจริงตามสถานการณ์
คำนวณแบบ |	Static (ไม่ค่อยเปลี่ยน) | Dynamic (อัปเดตตลอดเวลา)
ดูอะไร | ความรุนแรงตามทฤษฎี	 | โดนโจมตีจริงไหม? มี exploit ไหม?
ใช้เพื่อ |	บอกความรุนแรง |	บอกว่า “ควรแก้ด่วนไหม”
ตัวอย่าง |	0–10 |	0–10

a penetration test at a site with no internet connection. What tool could you use to find exploits to use? = Searchsploit(ใช้ตอนไม่มี net)
 ...
 ls
 nano 47887.py
 python3 47887.py http://10.64.189.113
 y
 ls
 cat flag.txt
...
ex: Fuel CMS 1.4
Fuel CMS 1.4.1 - Remote Code Execution (3) CVE: 2018-16763
nano exploit.py
...
python3 exploit.py -u http://10.64.155.13
ls 
system #it not work 
